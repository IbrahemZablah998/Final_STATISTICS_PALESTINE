...
class tulkarmController extends Controller
{
    ...
    public function index()
    {
        ...
        $chart = (new LarapexChart)->pieChart()
            ->setTitle('ذكر و انثى')
            ->setTitle('نسبة الذكر والانثى في محافظة طولكرم')
            ->addData([
        ...
        $chart1 = (new LarapexChart)->pieChart()
            ->setTitle('عدد السكان في محافظة طولكرم')
            ->addData([
        ...
        $chart2 = (new LarapexChart)->polarAreaChart()
            ->setTitle('نسبة الديانات في محافظة طولكرم')
            ->addData([
                \App\Models\family__data::where('place', '=', 'طولكرم')->where('religion', '=', 'مسلم')->count(),
                \App\Models\family__data::where('place', '=', 'طولكرم')->where('religion', '=', 'مسيحي')->count(),
            ])
        ...
        $usersmale = DB::table('family__datas')
            ...
            ->where('family__datas.place', '=', 'طولكرم')
            ->get();
        $chart3 = (new LarapexChart)->pieChart()
            ->setTitle('نسبة الولادات طيله الحياه الزوجيه(للنساء14 فاكثر)ٍ في محافظة طولكرم')
            ->addData([
        ...
        $chart4 = (new LarapexChart)->radialChart()
            ->setTitle('نسبة الولادات خلال ال 12 شهر السابقة (للنساء 14-54) في محافظة طولكرم')
            ->addData([
        ...
        $chart5 = (new LarapexChart)->donutChart()
            ->setTitle('الحالة الزواجية في محافظة طولكرم')
            ->addData([
        ...
        $chart6 = (new LarapexChart)->donutChart()
            ->setTitle('تكنولوجيا النعلومات لدى الاسرة(العدد) في محافظة طولكرم')
            ->addData([
        ...
        $chart7 = (new LarapexChart)->pieChart()
            ->setTitle('نسبة عدد الوفايات في محافظة طولكرم')
        ...
        return view('Palestine.tulkarm.tulkarm', $send);
    }
}
