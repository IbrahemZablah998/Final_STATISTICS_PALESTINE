...
class hebronController extends Controller
{
    ...
    public function index()
    {
        ...
        $chart = (new LarapexChart)->pieChart()
            ->setTitle('ذكر و انثى')
            ->setTitle('نسبة الذكر والانثى في محافظة الخليل')
            ->addData([
        ...
        $chart1 = (new LarapexChart)->pieChart()
            ->setTitle('عدد السكان في محافظة الخليل')
            ->addData([
        ...
        $chart2 = (new LarapexChart)->polarAreaChart()
            ->setTitle('نسبة الديانات في محافظة الخليل')
            ->addData([
                \App\Models\family__data::where('place', '=', 'الخليل')->where('religion', '=', 'مسلم')->count(),
                \App\Models\family__data::where('place', '=', 'الخليل')->where('religion', '=', 'مسيحي')->count(),
            ])
        ...
        $usersmale = DB::table('family__datas')
            ...
            ->where('family__datas.place', '=', 'الخليل')
            ->get();
        $chart3 = (new LarapexChart)->pieChart()
            ->setTitle('نسبة الولادات طيله الحياه الزوجيه(للنساء14 فاكثر)ٍ في محافظة الخليل')
            ->addData([
        ...
        $chart4 = (new LarapexChart)->radialChart()
            ->setTitle('نسبة الولادات خلال ال 12 شهر السابقة (للنساء 14-54) في محافظة الخليل')
            ->addData([
        ...
        $chart5 = (new LarapexChart)->donutChart()
            ->setTitle('الحالة الزواجية في محافظة الخليل')
            ->addData([
        ...
        $chart6 = (new LarapexChart)->donutChart()
            ->setTitle('تكنولوجيا النعلومات لدى الاسرة(العدد) في محافظة الخليل')
            ->addData([
        ...
        $chart7 = (new LarapexChart)->pieChart()
            ->setTitle('نسبة عدد الوفايات في محافظة الخليل')
        ...
        return view('Palestine.hebron.hebron', $send);
    }
}
