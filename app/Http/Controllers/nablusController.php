...
class nablusController extends Controller
{
    ...
    public function index()
    {
        ...
        $chart = (new LarapexChart)->pieChart()
            ->setTitle('ذكر و انثى')
            ->setTitle('نسبة الذكر والانثى في محافظة نابلس')
            ->addData([
        ...
        $chart1 = (new LarapexChart)->pieChart()
            ->setTitle('عدد السكان في محافظة نابلس')
            ->addData([
        ...
        $chart2 = (new LarapexChart)->polarAreaChart()
            ->setTitle('نسبة الديانات في محافظة نابلس')
            ->addData([
                \App\Models\family__data::where('place', '=', 'نابلس')->where('religion', '=', 'مسلم')->count(),
                \App\Models\family__data::where('place', '=', 'نابلس')->where('religion', '=', 'مسيحي')->count(),
            ])
        ...
        $chart3 = (new LarapexChart)->pieChart()
            ->setTitle('نسبة الولادات طيله الحياه الزوجيه(للنساء14 فاكثر)ٍ في محافظة نابلس')
            ->addData([
        ...
        $chart4 = (new LarapexChart)->radialChart()
            ->setTitle('نسبة الولادات خلال ال 12 شهر السابقة (للنساء 14-54) في محافظة نابلس')
            ->addData([
        ...
        $chart5 = (new LarapexChart)->donutChart()
            ->setTitle('الحالة الزواجية في محافظة نابلس')
            ->addData([
        ...
        $chart6 = (new LarapexChart)->donutChart()
            ->setTitle('تكنولوجيا النعلومات لدى الاسرة(العدد) في محافظة نابلس')
            ->addData([
        ...
        $chart7 = (new LarapexChart)->pieChart()
            ->setTitle('نسبة عدد الوفايات في محافظة نابلس')
        ...
        return view('Palestine.Nablus.nablus', $send);
    }
}
