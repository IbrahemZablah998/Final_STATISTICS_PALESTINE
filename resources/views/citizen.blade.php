...
<head>
    ...
    <title>مركز الاحصاء الفلسطيني</title>
                                    ...
                                    <table class="table table-bordered" style="overflow-x: scroll !important;min-width:500% !important;">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="" name="number_of_years_schooling" value="{{ $family_learnings->number_of_years_schooling ?? ''}}">
                                                </td>
                                                ...
                                                <td>
                                                    <input type="text" class="" name="highest_academic_qualification" value="{{ $family_learnings->highest_academic_qualification ?? ''}}">
                                                </td>
                                                <td>
                                                    <select class="" data-placeholder="Select" name="technical_vocational_qualification">
                                                ...
                                                <td>
                                                    <select class="" data-placeholder="Select" name="realationship_of_work">
                                                ...
                                                <td>
                                                    <select class="" data-placeholder="Select" name="overtime_work">
                                                ...
                                                <td>
                                                    <select class="" data-placeholder="Select" name="major_occupation">
                                                        <option {{ ((($family_work->major_occupation ?? '' )=='نعم')? "selected" : '' )}}>نعم</option>
                                                        <option {{ ((($family_work->major_occupation ?? '' )=='لا')? "selected" : '' )}}>لا</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" class="" name="major_economic_activity" value="{{ $family_work->major_economic_activity ?? ''}}">
                                                </td>
                                                <td>
                                                    <input type="text" class="" name="sector" value="{{$family_work->sector ?? ''}}">
                                                </td>
                                                <td>
                                                    <select class="" data-placeholder="Select" name="workplace">
                                                ...
                                                <td>
                                                    <select class="" data-placeholder="Select" name="main_practical_case">
                                                ...
                                                <td>
                                                    <select class="" data-placeholder="Select" name="work_contract">
                                                ...
                                                <td>
                                                    <select class="" data-placeholder="Select" name="vacations">
                                                ...
                                                <td>
                                                    <select class="" data-placeholder="Select" name="marriage_status">
                                                ...
                                                <td>
                                                    <input type="number" class="" name="age_first_marriage" value="{{$family_marriages->age_first_marriage ?? ''}}">
                                                </td>
                                                <td>
                                                    <input type="number" class="" name="duration_marriage" value="{{$family_marriages->duration_marriage ?? ''}}">
                                                </td>
                                                <td>
                                                    <input type="number" class="" name="number_for_life_born_a_live" value="{{$family_marriages->number_for_life_born_a_live ?? ''}}">
                                                </td>
                                                <td>
                                                    <input type="number" class="" name="number_for_life_a_live" value="{{$family_marriages->number_for_life_a_live ?? ''}}">
                                                </td>
                                                <td>
                                                    <input type="number" class="" name="number_for_annual_born_a_live" value="{{$family_marriages->number_for_annual_born_a_live ?? ''}}">
                                                </td>
                                                <td>
                                                    <input type="number" class="" name="number_for_annual_a_live" value="{{$family_marriages->number_for_annual_a_live ?? ''}}">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
